...
If you're looking for a hosting account to do all of this for you, [http://www.hostmonster.com/track/web2project/wiki Hostmonster] (hosting provider for web2project.net) is a good option.
...
#  Download the latest web2project release - ''either zip file or tarball'' -  from a selected Sourceforge site - e.g. https://sourceforge.net/projects/web2project/files/web2Project/.
...
#  Download the latest web2project release - ''either zip file or tarball'' -  from a selected Sourceforge site - e.g. http://sourceforge.net/projects/web2project/.
...
#  Copy any [[:Category:Add On Modules]] from your old ''/modules'' directory to the new one.
